...
const Notes = () => {
  ...
  useEffect(() => {
    fetch("https://backend-notemaker-right.vercel.app/note/allSaved")
      .then((res) => {
        if (res.ok) {
          return res.json();
        }
  ...
  const handleClick = (event) => {
    ...
    axios.post("https://backend-notemaker-right.vercel.app/note/writter", newwrittenNotes);
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        axios({
                          ...
                          method: "delete",
                          url: "https://backend-notemaker-right.vercel.app/note/Delete",
                          data: { _id: _id },
                        });
                      }}
                    >
